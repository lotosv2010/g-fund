...
| T1.1.6 | NestJS daily-snapshots 模块实现（新增） | [ ] | 0.5d |
...
| ID | 任务 | 状态 | 估时 |
|----|------|------|------|
| T1.3.1 | 导航重构：侧边栏菜单调整 + 路由重定向 | [ ] | 0.5d |
| T1.3.2 | Dashboard 总览页（StatCards + PnLChart + PositionPie + RecentTrades） | [ ] | 1.5d |
| T1.3.3 | 交易与持仓页（Tab 结构：持仓 / 交易 / 日志） | [ ] | 1.5d |
